...
CREATE TABLE public.procedures (
    ...
    steps jsonb DEFAULT jsonb_build_array() NOT NULL
);
...
CREATE TRIGGER "set_public_procedures_updatedAt" BEFORE UPDATE ON public.procedures FOR EACH ROW EXECUTE FUNCTION public."set_current_timestamp_updatedAt"();
COMMENT ON TRIGGER "set_public_procedures_updatedAt" ON public.procedures IS 'trigger to set value of column "updatedAt" to current timestamp on row update';
